  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-start relative items-center pt-9 font-extrabold text-justify text-5xl bg-grey w-full h-[20.5rem]">
        <div
          className={cn(
            "group flex flex-col gap-7 text-violetBlue",
            jua.className
          )}
        >
          <div className="flex ">
        ...
        <div
          className={cn(
            "flex flex-col items-strech relative bottom-14 text-textBlack ",
            manrope.className
          )}
        >
          <div className="flex flex-col items-center pr-2">
            <Button
              ...
              variant="outline"
              className=" bg-yellowDark rounded-lg w-[20.8rem]  justify-center items-strech gap-1 shadow-xl border-[1.5px] border-black h-[3.1rem]"
            >
              <Image
                src={location}
                alt="location_marker"
              ...
              />
              <span className="text-customfont_Sm tracking-wide font-semibold">
                Track Buses
              </span>
            </Button>
            ...
            <div className="flex flex-row gap-2 mt-1">
              <Image
                src={arrow_down}
                alt="arrowdown"
                className="object-contain size-4 mt-2  "
              />
              <span className="text-lg text-black text-center font-semibold underline ">
                Know More
              </span>
            </div>
          </div>
